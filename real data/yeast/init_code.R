...
load("用jmardtheta估计.RData")
load("用glasso.RData")
load("yeast20241203.RData")
load("最新.RData")
load("D:/OneDrive/Rcode/SOFARI/jasa/real data/yeast/code/yeast/RData/yeast_preprocess_data.RData")
dim(X)
dim(Y)
