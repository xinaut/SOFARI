...
ada.thresholding <- function(p = p, n = n, delta = 2, thresholding = 'hard', data, cov_true) {#cov_true: not used
  # compute theta
...
ada.thresholding.find.delta <- function(delta = delta, 
                           fold.id = fold.id, 
                           p = p, 
                           n = n, 
                           thresholding = 'hard', 
...
ada.thresholding.cv <- function(n = n, p = p, data, cov_true){
  measure <- '2';
